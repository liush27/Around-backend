...
const (
	...
	ES_URL = "..."  // Needs to update this URL if you deploy it to cloud.

	ENABLE_MEMCACHE = false
	ENABLE_BIGTABLE = false
	REDIS_URL = "..." // Need to update with redis url 
	REDIS_PASSWORD = "..."// Need to update based on your settings
)

var (
	mySigningKey = []byte("secret")
	GCS_BUCKET = "..."	//Need to udpate based on your settings
	BIGTABLE_PROJECT_ID = "..." // Need to update based on your settings
)
